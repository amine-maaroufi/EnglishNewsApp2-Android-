...
public class EconomicFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_economic, null);
   ...
   public class GridSpacingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void initViews(View view){
        ...
        try {
            Glide.with(this).load(R.drawable.covereconomic).into((ImageView) view.findViewById(R.id.backdrop));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void loadJSON(){
        try{
            ...
            Call<EconomicReponse> call = apiService.getEconomic();
